...
//    override fun getPageTitle(position: Int): CharSequence? = mFragmentTitle[position]
    ...
    fun getTabView(position: Int): View? {
        ...
        view.findViewById<TextView>(R.id.tvTitle).apply {
            ...
            if (position == 0) {
                setTextColor(getAppColor(R.color.colorWhile_100))
                setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.ic_point_selected_red)
            } else {
