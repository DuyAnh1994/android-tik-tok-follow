package com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.window;
...
import com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.util.AspectRatioUtil;
import com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.util.HandleUtil;
import com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.util.PaintUtil;
import com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.window.edge.Edge;
import com.solar.dev.tiktok.app.ui.customview.cropvideo.cropview.window.handle.Handle;
...
public class CropView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawRuleOfThirdsGuidelines(canvas); // vẽ khung từ đầu
        if (showGuidelines()) {
            if (mGuidelines == 2) {
    ...
    private void drawCorners(Canvas canvas) {
        ...
        canvas.drawCircle(left - mCornerOffset + 3, top - mCornerExtension + 10, 20, mCornerPaint);
        canvas.drawCircle(left - mCornerOffset + 3, bottom - mCornerExtension + 10, 20, mCornerPaint);
        canvas.drawCircle(right - mCornerOffset + 3, top - mCornerExtension + 10, 20, mCornerPaint);
        canvas.drawCircle(right - mCornerOffset + 3, bottom - mCornerExtension + 10, 20, mCornerPaint);
